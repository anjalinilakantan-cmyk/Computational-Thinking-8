...
#This is where the colorful squares are!
...
#my favorite things as sprites in the codespace!
s1 = create_sprite("animatedgiraffe", 100, 100)
s2 = create_sprite("cardinal", -100, -100)
s3 = create_sprite("texas", 100, -100)
s4 = create_sprite("dogs", -100, 100)

#i love the color pink
message1 = create_sprite("alien",-200,200)
message1.color("pink")
message1.write("Anjali",font = ("Arial", 40, "normal"))
message1.hideturtle()
